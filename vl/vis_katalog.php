...
echo '<br>' 
      ...
      for ($x = 1; $x <= $sider; $x++) {
          ...
          if($x==$side){
              if(mobile_browser()==true){echo '<a href="frame_viskatalog_mobile.php?page=' .$x .'& gruppe=' .$gruppenr .'& pris_min=' .$pris_min .'& pris_max=' .$pris_max .'&' .http_build_query($filter_variable)  .'"><b>' .$x .'</b></a>';}
              ...
              if(mobile_browser()==true){echo '<a href="frame_viskatalog_mobile.php?page=' .$x .'& gruppe=' .$gruppenr .'& pris_min=' .$pris_min .'& pris_max=' .$pris_max .'&' .http_build_query($filter_variable)  .'">' .$x .'</a>';}
