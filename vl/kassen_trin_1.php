...
<html>
    <center> 
        ...
        If ($logget_ind != "ja") {
            ?>
            <form name="pris_form" action="../vl/frame_login<?php if (mobile_browser()) {
                echo "_mobile";
            } ?>.php?kob=1" method="POST" class="loginform cf">
                <b>Allerede bruger </b>
            ...
            <section class="loginform cf">
                <form name="login" action="../fl/opret_kunde_kob.php" onsubmit="return checkForm(this);">
                    ...
                    <ul>
                        ...
                        <li>
                            <label >Email</label>
                            <input <?php if (isset($_SESSION["logget_ind_kunde"])) {
                        if ($_SESSION["logget_ind_kunde"] == "ja") { ?>readonly="readonly"<?php }
                    } ?> type="email" name="email" required value="<?php echo $email; ?>">
                            <br>
                        </li>
                        <li>
                            <label>Adresse</label>
